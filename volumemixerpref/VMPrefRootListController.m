...
- (void)viewDidLoad{
  ...
  _old_prefs = [NSDictionary dictionaryWithContentsOfFile:@THEOS_PACKAGE_INSTALL_PREFIX"/var/mobile/Library/Preferences/com.vasirakcalgux.volumemixer.plist"];
...
-(void)_reset{
  ...
  notify_post("com.vasirakcalgux.volumemixer/loadPref");
}
- (void)_migrate{
  for(NSString *oldKey in _old_prefs){
    id value = _old_prefs[oldKey];
    NSString *newKey = [@"com.vasirakcalgux.volumemixer_" stringByAppendingString:oldKey];
