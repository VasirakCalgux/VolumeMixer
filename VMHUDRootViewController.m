...
- (void)initServer {
    _center = [MRYIPCCenter centerNamed:@"com.vasirakcalgux.volumemixer/register"];
...
- (void)register:(NSDictionary *)args {
    ...
    NSString *appNotify = [NSString stringWithFormat:@"com.vasirakcalgux.volumemixer/%@~%d/setVolume", bundleID, pid.intValue];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        hudView.boostEnabled = _boostEnabled;
...
- (void)loadPref {
    ...
    // Volume Boost: Load the boostEnabled preference
    _boostEnabled = [g_defaults objectForKey:kPrefBoostEnabledKey] ? [g_defaults boolForKey:kPrefBoostEnabledKey] : NO;
